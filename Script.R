...
#Création d'un tableau récapitulatif des résultats des tests
tests <- data.frame(Model = c("1994", "1998", "2002", "2006", "2010", "2014", "2018", "2022"),
                      BP_p_value = round(c(bp_1994$p.value, bp_1998$p.value, bp_2002$p.value, bp_2006$p.value, bp_2010$p.value, bp_2014$p.value, bp_2018$p.value, bp_2022$p.value), 4),
                      DW_p_value = round(c(dw_1994, dw_1998, dw_2002, dw_2006, dw_2010, dw_2014, dw_2018, dw_2022), 4),
                      VIF_Value = round(c(vif_1994, vif_1998, vif_2002, vif_2006, vif_2010, vif_2014, vif_2018, vif_2022), 4))
tests
