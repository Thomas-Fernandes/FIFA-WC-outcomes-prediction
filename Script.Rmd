...
### 4.1.1 Estimations des modèles des modèles et tests d'hétéroscédasticité, d'autocorrelation et de multicolinéarité 
...
## 4.2 Modèle de regression binomiale (modèle probit)
...
```{r}
#On estime le modèle probit pour la Coupe du Monde 1994
model_1994 <- glm(Home.Win ~ FIFA_Rank.Diff +
                        Goals_Diff +
                        Yellow.Card.Diff +
                        Red.Card.Diff,
                        data = WC_1994,
...
#Stargazer le modèle
stargazer(model_1994, type = "text", digits = 3, title = "Modèle de régression probit pour la Coupe du Monde 1994", column.labels = c("1994"))

#On estime le modèle probit pour la Coupe du Monde 2006
model_2006 <- glm(Home.Win ~ FIFA_Rank.Diff +
                        Possession.Diff +
                        Shots.Diff +
                        Shots.On.Target.Diff +
                        Fouls.Diff +
                        Saves.Diff +
                        Yellow.Card.Diff +
                        Red.Card.Diff,
...
#Stargazer le modèle
stargazer(model_2006, type = "text", digits = 3, title = "Modèle de régression probit pour la Coupe du Monde 2006", column.labels = c("2006"))
```
