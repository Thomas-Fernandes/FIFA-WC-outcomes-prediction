...
WC_database$hshots[is.na(WC_database$hshots) & WC_database$Year == 2022] <-
  WC_matches_2022_22$hshots[match(paste(WC_database$Home[is.na(WC_database$hshots) & WC_database$Year == 2022]),
                                  paste(WC_database$Away[is.na(WC_database$hshots) & WC_database$Year == 2022]),
                                  WC_matches_2022_22$Year)]
WC_database$ashots[is.na(WC_database$ashots) & WC_database$Year == 2022] <-
  WC_matches_2022_22$ashots[match(paste(WC_database$Home[is.na(WC_database$ashots) & WC_database$Year == 2022]),
                                  paste(WC_database$Away[is.na(WC_database$ashots) & WC_database$Year == 2022]),
                                  WC_matches_2022_22$Year)]
WC_database$hshotsOnTarget[is.na(WC_database$hshotsOnTarget) & WC_database$Year == 2022] <-
      WC_matches_2022_22$hshotsOnTarget[match(paste(WC_database$Home[is.na(WC_database$hshotsOnTarget) & WC_database$Year == 2022]),
                                                paste(WC_database$Away[is.na(WC_database$hshotsOnTarget) & WC_database$Year == 2022]),
                                                WC_matches_2022_22$Year)]
WC_database$ashotsOnTarget[is.na(WC_database$ashotsOnTarget) & WC_database$Year == 2022] <-
      WC_matches_2022_22$ashotsOnTarget[match(paste(WC_database$Home[is.na(WC_database$ashotsOnTarget) & WC_database$Year == 2022]),
                                                paste(WC_database$Away[is.na(WC_database$ashotsOnTarget) & WC_database$Year == 2022]),
                                                WC_matches_2022_22$Year)]
WC_database$hfouls[is.na(WC_database$hfouls) & WC_database$Year == 2022] <-
      WC_matches_2022_22$hfouls[match(paste(WC_database$Home[is.na(WC_database$hfouls) & WC_database$Year == 2022]),
                                        paste(WC_database$Away[is.na(WC_database$hfouls) & WC_database$Year == 2022]),
                                        WC_matches_2022_22$Year)]
WC_database$afouls[is.na(WC_database$afouls) & WC_database$Year == 2022] <-
      WC_matches_2022_22$afouls[match(paste(WC_database$Home[is.na(WC_database$afouls) & WC_database$Year == 2022]),
                                        paste(WC_database$Away[is.na(WC_database$afouls) & WC_database$Year == 2022]),
                                        WC_matches_2022_22$Year)]
WC_database$hPossesion[is.na(WC_database$hPosession) & WC_database$Year == 2022] <-
      WC_matches_2022_22$hPossession[match(paste(WC_database$Home[is.na(WC_database$hPossesion) & WC_database$Year == 2022]),
                                           paste(WC_database$Home[is.na(WC_database$hPossesion) & WC_database$Year == 2022]),
                                           WC_matches_2022_22$Year)]
