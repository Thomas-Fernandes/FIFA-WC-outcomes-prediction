...
L'objectif de cette étude est de répliquer les résultats de l'article en utilisant en utiisant les mêmes données que les auteurs, ainsi que d'autres plus récentes. Bien que le modèle probit et le modèle de régression linéaire MCO proposés dans l'article soient reproductibles, certaines variables de contrôle utilisées par les auteurs ne sont pas disponibles pour la période de 206 à 2022. Ainsi, nous avons remplacé ces variables par d'autres indicateurs pertinents, tels que le nombre de changement effectué par chaque équipe, le nombre de tirs en plus du nombre de tirs cadrés, ainsi que le nombre d'arrêts. En utilisant ces variables alternatives, nous examinons si les conclusions de l'article original peuvent être étendues à une période plus récente de la Coupe du monde de football. Nous testons également la validité de la méthode de classement de la FIFA et de son utilisation comme proxy pour la performance des équipes.
